      ...
      <div className="space-y-6">
        ...
        <div className="rounded-xl bg-gradient-to-r from-rose-50 to-amber-50 p-5">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-foreground">Alexandre est Superhôte</h3>
              <p className="mt-1 text-sm text-secondary">
                Superhôte sur Airbnb depuis avril 2024 — les Superhôtes sont des hôtes
                expérimentés, très bien notés, qui s&apos;engagent à offrir d&apos;excellents séjours.
              </p>
            </div>
          </div>
        </div>
