...
const T: Record<Locale, { title: string; sub: string; metaTitle: string; metaDesc: string }> = {
  fr: {
    ...
    metaDesc: "9 suites privatives avec lit double, salle de bain privative, smart TV, bureau Ethernet et clé individuelle. Jusqu'à 18 personnes au Mans.",
  },
  en: {
    ...
    metaDesc: "9 private suites with double bed, en-suite bathroom, smart TV, desk with Ethernet and individual key. Up to 18 guests in Le Mans.",
  },
  it: {
    ...
    metaDesc: "9 suite private con letto matrimoniale, bagno privato, smart TV, scrivania Ethernet e chiave individuale. Fino a 18 ospiti a Le Mans.",
  },
  de: {
