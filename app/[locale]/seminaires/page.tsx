...
const T: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    whatItems: "9 suites privatives·215 m² (espaces communs + chambres + annexe sport/zen)·Wi-Fi haut débit·Cuisine entièrement équipée·Salle de sport + espace zen·Serrure connectée (self check-in)·Facture professionnelle, paiement virement·Support WhatsApp 7j/7",
    ...
    extrasItems: "Traiteurs locaux (petit-déj, déjeuner, dîner)·Taxis pour les transferts gare/circuit/maison·Prestataires d'activités team-building (karting, simulateurs, EVA…)",
  ...
  en: {
    ...
    whatItems: "9 private suites·215 m² total (common areas + bedrooms + gym/zen annex)·High-speed Wi-Fi·Fully equipped kitchen·Gym + zen space·Smart lock (self check-in)·Professional invoice, bank transfer·WhatsApp support 7 days a week",
  ...
  it: {
    ...
    whatItems: "9 suite private·215 m² (spazi comuni + camere + annesso sport/zen)·Wi-Fi ad alta velocità·Cucina completamente attrezzata·Palestra + spazio zen·Serratura connessa (self check-in)·Fattura professionale, pagamento con bonifico·Supporto WhatsApp 7 giorni su 7",
  ...
  de: {
    ...
    whatItems: "9 private Suiten·215 m² (Gemeinschaftsräume + Zimmer + Sport-/Zen-Annex)·Highspeed-WLAN·Voll ausgestattete Küche·Fitnessraum + Zen-Bereich·Smart Lock (Self-Check-in)·Professionelle Rechnung, Zahlung per Überweisung·WhatsApp-Support 7 Tage die Woche",
  ...
  es: {
    ...
    whatItems: "9 suites privadas·215 m² (espacios comunes + habitaciones + anexo deporte/zen)·Wi-Fi alta velocidad·Cocina totalmente equipada·Gimnasio + espacio zen·Cerradura conectada (self check-in)·Factura profesional, pago por transferencia·Soporte WhatsApp 7 días a la semana",
