  ...
  return (
    <>
      <p className="lead">
        ...
        Finding accommodation for the 2027 edition takes planning — hotels are booked
        out months ahead and large houses go the moment booking opens. Here's a
        practical guide to pick where to stay.
      </p>

      <h2>When is the 24 Hours of Le Mans 2027?</h2>
      <p>
        The 95th edition of the 24 Hours of Le Mans takes place on the weekend of{" "}
        <strong>12-13 June 2027</strong>. Free practice and qualifying start on Wednesday,
      ...
      <p>
        ...
        Mans 2027 and secure your stay. You can also discover{" "}
