...
export default function Article() {
  return (
    <>
      ...
      <p>
        The next edition runs from <strong>2 to 5 July 2026</strong> at the 24 Hours
      ...
      <p>
        We still have availability for Le Mans Classic, from <strong>2 to 5 July 2026</strong>.
