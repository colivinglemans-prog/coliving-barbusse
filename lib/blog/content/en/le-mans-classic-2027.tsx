  ...
  return (
    <>
      ...
      <p>
        ...
        20) is available for the 2027 edition.{" "}
      ...
      <p>
        The next edition runs from <strong>1 to 4 July 2027</strong> at the 24 Hours
        Circuit. Check the official website at{" "}
      ...
      <p>
        We still have availability for Le Mans Classic, from <strong>1 to 4 July 2027</strong>.
        Book <strong>direct, with no commission</strong>: check our{" "}
        <Link href="/en#disponibilite">real-time calendar</Link> and get the best rate before
        the last spots go.
      </p>
    </>
  );
