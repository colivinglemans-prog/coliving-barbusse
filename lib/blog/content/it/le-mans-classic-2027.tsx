  ...
  return (
    <>
      ...
      <p>
        ...
        (fino a 20&nbsp;persone) è disponibile per l'edizione&nbsp;2027.{" "}
      ...
      <p>
        La prossima edizione si tiene dal <strong>1º al 4 luglio 2027</strong> al Circuito
      ...
      <p>
        ...
        fino a 20 persone in una cornice tranquilla, a 20 minuti dal
      ...
      <p>
        Abbiamo ancora disponibilità per Le Mans Classic, dal <strong>1º al 4 luglio
        2027</strong>. Prenotate <strong>in diretta, senza commissioni</strong>: consultate il{" "}
