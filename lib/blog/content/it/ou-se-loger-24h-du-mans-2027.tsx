  ...
  return (
    <>
      <p className="lead">
        ...
        Mans. Trovare un alloggio per l'edizione 2027 richiede di muoversi per tempo — gli
      ...
      <h2>Quando si svolge la 24 Ore di Le Mans 2027?</h2>
      <p>
        La 95ª edizione della 24 Ore di Le Mans si tiene nel weekend del{" "}
        <strong>12 e 13 giugno 2027</strong>. Le prove libere e le qualifiche iniziano già
      ...
      <p>
        ...
        Le Mans 2027 e assicurati il soggiorno. Puoi anche scoprire{" "}
