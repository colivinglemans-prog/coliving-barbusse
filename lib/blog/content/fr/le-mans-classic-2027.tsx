  ...
  return (
    <>
      ...
      <p>
        ...
        9&nbsp;suites (jusqu'à 20&nbsp;personnes) est disponible pour l'édition&nbsp;2027.{" "}
      ...
      <p>
        La prochaine édition se tient du <strong>1ᵉʳ au 4 juillet 2027</strong> au Circuit des
      ...
      <p>
        Le Mans centre reste l'option la plus pratique : 20 minutes du circuit hors événement (30-45 min les jours de course), mais loin des
      ...
      <p>
        Nos <strong>9 suites privatives avec salles de bain</strong> accueillent jusqu'à 20
        personnes dans un cadre calme, à 20 minutes du Circuit Bugatti hors événement (30-45 min les jours de course) :
      </p>
      <ul>
      ...
      <p>
        Il nous reste des disponibilités pour Le Mans Classic, du <strong>1ᵉʳ au 4 juillet
        2027</strong>. Réservez <strong>en direct, sans commission</strong> : consultez le{" "}
