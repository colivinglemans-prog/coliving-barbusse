  ...
  return (
    <>
      <p className="lead">
        ...
        Mans. Trouver un hébergement pour l'édition 2027 demande de s'y prendre tôt — les hôtels
      ...
      <h2>Quand ont lieu les 24 Heures du Mans 2027 ?</h2>
      <p>
        La 95ᵉ édition des 24 Heures du Mans se déroule le week-end du <strong>12 et 13 juin 2027</strong>.
      ...
      <ul>
        ...
        <li>Grande maison pour groupe (10-20 pers.) : 1 500-3 500 €/nuit</li>
      </ul>
      <p>
      ...
      <p>
        ...
        <strong>9 chambres doubles avec salle de bain privative</strong>. Vous dormez à 20
      ...
      <p>
        ...
        du Mans 2027 et sécurisez votre séjour. Vous pouvez aussi découvrir{" "}
