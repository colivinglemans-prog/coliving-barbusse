...
export const it: Dictionary = {
  ...
  propertyHeader: {
    ...
    travelers: "20 ospiti",
    rooms: "9 camere",
    beds: "9 letti matrimoniali + 2 divani letto",
...
Due camere dispongono anche di un divano letto singolo: la casa ospita fino a 20 persone.`,
  },
  sleeping: {
    title: "Dove dormirai",
    room: "Camera",
    doubleBed: "1 letto matrimoniale",
    doubleBedSofa: "1 letto matrimoniale + 1 divano letto (1 posto)",
  ...
  calendar: {
    ...
    clear: "Cancella",
    bookNow: "Prenota ora",
    directDiscount: "Miglior prezzo garantito: −7% prenotando diretto rispetto alle piattaforme",
  ...
  reviews: {
    ...
    hostReplyLabel: "Risposta di Alexandre",
    autoTranslated: "Tradotto automaticamente",
    showOriginal: "Vedi l'originale",
